...
//                            .isDialog(true) //默认设置false ，内部实现将DecorView 作为它的父控件。
    ...
    private void updateOss(String filename, String filePath) {
        ...
        OssService ossService = new OssService(AddTaskActivity.this, OssService.ACCESS_KEY_ID, OssService.ACCESS_KEY_SECRET, "http://oss-cn-shanghai.aliyuncs.com", "jjjt");
        //初始化OSSClient

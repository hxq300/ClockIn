 ...
 * todo : 采购
 */
public class PurchaseActivity extends AppCompatActivity implements ApprovalInterface.View {

    @BindView(R.id.approval_toolbar)
    IToolbar approvalToolbar;
    @BindView(R.id.caigou_type)
    TextView caigouType;
    @BindView(R.id.caogou_amount)
    TextView caogouAmount;
    @BindView(R.id.caogou_reasons)
    TextView caogouReasons;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        presenter = new ApprovalPresenter(this, PurchaseActivity.this);
    ...
    private void initData() {
        ...
        if (recordData.getContent() != null) {
            caogouReasons.setText("" + recordData.getContent());
        }

        caogouAmount.setText("" + recordData.getProcurement_sum());

        if (recordData.getExamine_type() != null) {
            caigouType.setText("" + recordData.getExamine_type());
        }

 ...
 * todo :
 */
public class LeaveActivity extends AppCompatActivity implements ApprovalInterface.View {

    @BindView(R.id.leave_toolbar)
    IToolbar leaveToolbar;
    @BindView(R.id.leave_stime)
    TextView leaveStime;
    @BindView(R.id.leave_etime)
    TextView leaveEtime;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        presenter = new ApprovalPresenter(this, LeaveActivity.this);
    ...
    private void initData() {
        ...
        if (recordData.getStart_time() != null) {
            leaveStime.setText("" + recordData.getStart_time());
        }

        if (recordData.getEnd_time() != null) {
            leaveEtime.setText("" + recordData.getEnd_time());
        }

...
public class PlayersActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        sharedUtils = new SharedUtils(PlayersActivity.this, SharedUtils.CLOCK);

        sharedUtils.setData(SharedUtils.JOINID, "");
        sharedUtils.setData(SharedUtils.JOINNAME, "");

//        String listIds = sharedUtils.getData(SharedUtils.JOINID, null);
//
//        String nameIds = sharedUtils.getData(SharedUtils.JOINNAME, null);
//        if (listIds != null) {
//            try {
...
//        }
    ...
    private void initRecycle() {
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(PlayersActivity.this);
        ...
        commonAdapter = new CommonAdapter<Staff>(this, R.layout.item_commit_staff, staffList) {
            ...
            protected void convert(ViewHolder holder, Staff data, int position) {
                ...
                Glide.with(PlayersActivity.this).load(RequestURL.OssUrl + data.getPicture())
...
//                //请求成功数据回调
    ...
    public void onViewClicked() {
        sharedUtils.setData(SharedUtils.JOINID, ids.toString());
        sharedUtils.setData(SharedUtils.JOINNAME, names.toString());
        finish();
    }
}

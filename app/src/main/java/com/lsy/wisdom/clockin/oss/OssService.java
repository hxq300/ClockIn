package com.lsy.wisdom.clockin.oss;
...
//                    LogUtil.e("UploadFailure：表示在OSS服务端发生错误");
                    L.log("ErrorCode", serviceException.getErrorCode());
                    L.log("RequestId", serviceException.getRequestId());
                    L.log("HostId", serviceException.getHostId());
                    L.log("RawMessage", serviceException.getRawMessage());
                }
            }
        });
        //task.cancel(); // 可以取消任务

...
//            uri = data.toUri(MediaStore.EXTRA_OUTPUT);
    ...
    private void updateOss(String filename, String filePath) {
        ...
        OssService ossService = new OssService(PersonalDataActivity.this, OssService.ACCESS_KEY_ID, OssService.ACCESS_KEY_SECRET, "http://oss-cn-shanghai.aliyuncs.com", "jjjt");
        //初始化OSSClient

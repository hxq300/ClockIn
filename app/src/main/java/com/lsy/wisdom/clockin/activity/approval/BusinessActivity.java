 ...
 * todo : 出差
 */
public class BusinessActivity extends AppCompatActivity implements ApprovalInterface.View {
    ...
    TextView endDate;
    @BindView(R.id.business_detailed_address)
    TextView businessDetailedAddress;
    @BindView(R.id.business_reasons)
    EditText businessReasons;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        presenter = new ApprovalPresenter(this, BusinessActivity.this);
    ...
    private void initData() {
        ...
        if (recordData.getContent() != null) {
            businessReasons.setText("" + recordData.getContent());
        }

        if (recordData.getOuttime() != null) {
            startDate.setText("" + recordData.getOuttime());
        }

        if (recordData.getIntime() != null) {
            endDate.setText("" + recordData.getIntime());
        }

        if (recordData.getOutaddress() != null) {
            businessDetailedAddress.setText("" + recordData.getOutaddress());
        }

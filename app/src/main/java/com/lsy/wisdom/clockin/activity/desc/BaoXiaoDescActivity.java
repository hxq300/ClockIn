 ...
 * todo : 报销详情
 */
public class BaoXiaoDescActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_baoxiao_desc);
    ...
    private void initData() {
        ...
        listAdapter = new CommonAdapter<String>(getApplicationContext(), R.layout.view_reimburse_image, images) {
            ...
            protected void convert(ViewHolder holder, String iamge, int position) {
                ...
                Glide.with(BaoXiaoDescActivity.this).load(RequestURL.OssUrl + iamge).into(image);
